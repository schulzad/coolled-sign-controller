...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="opensign-send",
        description="Encode a profile-driven payload and write it to the panel; pass --dry-run to only build the plan.",
    )
    ...
    control.add_argument("--dry-run", action="store_true", help="Only build the packet plan; do not write over BLE.")
    ...
    bundle.add_argument("--dry-run", action="store_true", help="Only build the packet plan; do not write over BLE.")
